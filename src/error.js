...
export const ErrorFactory = {
  ...
  MAX_ERRORS_EXCEEDED: (errorLimit: number) => new StubbornFetchError("Max_Errors_Exceeded", null, {errorLimit}),
  NETWORK_ERROR: (underlyingError: Error) => new StubbornFetchError("Network", null, {underlyingError}),
